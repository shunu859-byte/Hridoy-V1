...
module.exports = {
        ...
        langs: {
                bn: {
                        error: "× তথ্য সংগ্রহ করতে সমস্যা হয়েছে: %1। প্রয়োজনে Contact Kakashi।"
                },
                en: {
                        error: "× Failed to fetch info: %1. Contact Kakashi for help."
                },
                vi: {
                        error: "× Lỗi lấy thông tin: %1. Liên hệ Kakashi để hỗ trợ."
                }
        },
